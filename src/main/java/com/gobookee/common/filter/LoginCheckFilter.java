...
public class LoginCheckFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        boolean isPublic = uri.equals(contextPath + "/") || uri.startsWith(contextPath + "/login") || uri.startsWith(contextPath + "/signup") ||
                uri.startsWith(contextPath + "/resources/") || uri.startsWith(contextPath + "/find") || uri.startsWith(contextPath + "/ajaxnicknameduplicate")
                || uri.startsWith(contextPath + "/ajaxuseridduplicate") || uri.startsWith(contextPath + "/logout") || uri.startsWith(contextPath + "/sendemail") || uri.startsWith(contextPath + "/verifycode");

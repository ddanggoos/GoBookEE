...
<section class="login-section">
  ...
  <div class="login-form">
      <div class="form-group">
        ...
        <input id="userId" class="btn btn-lg" type="text" name="userId" value="<%=saveId!=null?saveId:"" %>" placeholder="아이디를 입력하세요" />
      </div>


      <div class="form-group">
        <label for="userPwd">비밀번호</label>
        <input id="userPwd" class="btn btn-lg" type="password" name="userPwd" placeholder="비밀번호를 입력하세요"/>
      </div>
      
        <div class="userFunction">
      		<div class="loginCheckbox">
    				<input type="checkbox" class="checkbox" name="saveId" id="saveId" <%=saveId!=null?"checked":"" %> /> 
    	...
    	<button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-dark btn-lg">회원가입</button>
    </div>
   </div>
    </form>

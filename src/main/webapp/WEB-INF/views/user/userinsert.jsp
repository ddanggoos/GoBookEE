	...
	<form action="<%=request.getContextPath()%>/signup" method="post" onsubmit="return validatorForm()">
        ...
        <div class="input-group input-group-custom">
		 ...
		 <label class="form-label text-green">주소 <span style="color:#50A65D">*</span></label>
		  <div class="input-group input-group-custom">
            <input type="text" name="userAddress" id="userAddress" class="form-control" placeholder="주소를 입력하세요" readonly>
            <span class="input-group-text">
            	 <button type="button" onclick="sample5_execDaumPostcode();"  class="go-inner-btn btn btn-dark">주소찾기</button>
            ️</span>
        </div>
    	<!-- 상세주소 -->
    	 <label class="form-label text-green">상세주소 <span style="color:#50A65D">*</span></label>
        <div class="input-group input-group-custom">
            <input type="text" class="form-control" id="userAddressDetail" name="userAddressDetail" placeholder="상세주소를 입력하세요">
        </div>
        <!-- 아이디 -->
        ...
        <div class="input-group input-group-custom">
            <input type="password" name="userPwdCheck" class="form-control" id="userPwdCheck" placeholder="비밀번호를 입력하세요">
            <span class="input-group-text icon">
        ...
        <div class="input-group input-group-custom">
            <input type="text" class="form-control" name="userEmailCheckNum" id="userEmailCheckNum" placeholder="인증번호를 입력하세요">
            <span class="input-group-text">
...
<div class="modal fade" id="nickNameDuplicatemodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">닉네임 중복 확인 결과</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">

...
<main>
	...
	<section style= "text-align:center;">
	 <div class="userBtn">
    	<button type="button" class="btn btn-dark btn-lg">아이디 찾기</button> 		
    	<button type="button" class="btn btn-dark btn-lg">비밀번호 찾기</button>
    </div>
	</section>
	<section style= "text-align:center; margin-top: 140px;">
		 <p class="insertUser" >계정이 없으신가요? <a data-bs-toggle="modal" data-bs-target="#exampleModal" style="color:#50A65D">등록</a></p>
	</section>

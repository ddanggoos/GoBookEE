...
<div class="tab-container">
  <button class="tab-button " onclick="location.assign('<%=request.getContextPath()%>/studygroup/listpage/active')">
    진행 예정 <span class="tab-count">9</span>
  </button>
  <button class="tab-button active" disabled>
    진행 완료 <span class="tab-count">0</span>
  </button>
</div>

...
<main>
            ...
            <div class="profile-2">
                ...
                <div class="progress" style="height: 25px; width: 500px; position: relative; overflow: visible;">
                    ...
                    <span class="speed-logo"
                          style="z-index: 101; position: absolute; top: -17px; left: <%=adjustedLeftPercent%>%;
                ...
                <div class="gobooke-speed">
                    ...
                    <div class="speed-icon">
                        ...
                        <p style="margin-left:14px; transform: scaleX(-1);">🚗</p>
                        <p style="transform: scaleX(-1);">🚅</p>
                        <p>✈️</p>
                        <p>🚀</p>
                    </div>
    ...
    <section class="mypage-menulist">
        <div class="menulist">
            ...
            <div class="box">
                <i class="bi bi-book-fill icon"
                   onclick="location.assign(`<%=request.getContextPath()%>/mypage/myboard`)"></i>
                <h4>내가 쓴 글 목록</h4>
        ...
        <div class="menulist">
            <div class="box">
                <i class="bi bi-hand-thumbs-up-fill icon"
                   onclick="location.assign(`<%=request.getContextPath()%>/mypage/recboard`)"></i>
                <h4>내가 추천한 글</h4>
                <p><%= request.getAttribute("recommendedCount") %>
                </p>
            </div>
            <div class="box">
                <i class="bi bi-people-fill icon"
                   onclick="location.assign(`<%=request.getContextPath()%>/mypage/mystudy`)"></i>
                <h4>내 스터디</h4>

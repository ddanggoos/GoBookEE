...
<%@ page
        import="java.sql.Timestamp,
                java.util.List,
                com.gobookee.review.model.dto.*,
                com.gobookee.common.DateTimeFormatUtil,
...
<section>
    <main>
        <div class="container py-4">
            ...
            <!-- 제목 -->
            <h5 class="fw-bold mb-2"><%=review.getReviewTitle()%>
            </h5>
            ...
            <div class="d-flex align-items-start justify-content-between mb-3">
                <div class="d-flex">
                    ...
                    <div>
                        <div class="fw-semibold"><%=review.getUserNickName()%>
                        </div>
            ...
            <div
                ...
                <div>
                    <h6 class="mb-1"><%=review.getBookTitle()%>
                    </h6>
                    <p class="mb-1 text-muted small"><%=review.getBookDescription()%>
                    </p>
                    <div class="text-muted small"><%=review.getBookAuthor()%>
                    </div>
                    <div class="review-meta mt-2">
                        <strong>리뷰 <%=review.getBookReviewCount()%>개 | 평점 ★ <%=review.getBookAvgRate()%></strong>
            ...
            <p class="text-muted mb-1 review-content" style="font-size: 1.2rem;"><%=review.getReviewContents()%>
            </p>
            ...
            <div class="border-top pt-3">
                ...
                <div class="border rounded p-2 mb-2">
                    ...
                    <div class="mt-1 comment-content ps-3"><%=c.getCommentsContents()%>
                    </div>
                    ...
                    <div class="child-comments mt-2"
                        ...
                        <div class="border rounded p-2 mb-2 bg-light ms-4">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <strong><%=child.getUserNickName()%>
                                    </strong> <small
                                        class="text-muted ms-2"><%=DateTimeFormatUtil.format(child.getCommentsCreateTime())%>
                                </small>
                                </div>
                                <!-- 추천/비추천 버튼 -->
                                <div class="d-flex align-items-center gap-3 mb-3">
                                    ...
                                    <button
                                        ...
                                        <i class="bi bi-hand-thumbs-up me-1"
                                           style="font-size: 0.9rem;"></i> <span
                                            class="count"><%=child.getRecommendCount()%></span>
                                    </button>
                                    ...
                                    <button
                                        ...
                                        <i class="bi bi-hand-thumbs-down me-1"
                                           style="font-size: 0.9rem;"></i> <span
                                            class="count"><%=child.getNonRecommendCount()%></span>
                                    </button>
                                    <%
                                        }
                                    %>
                            ...
                            <div class="mt-1 comment-content ps-3"><%=child.getCommentsContents()%>
                            </div>
                        </div>
                        <%
                                }

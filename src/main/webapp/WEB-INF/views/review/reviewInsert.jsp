...
<div class="py-4 px-3" style="width: 40%; max-width: none; margin: 0;">
    ...
    <h5 class="fw-bold mb-4"><%= isUpdate ? "수정하기" : "리뷰 쓰기" %>
    </h5>
    ...
    <form
        ...
        <input type="hidden" name="reviewSeq"
               value="<%= review.getReviewSeq() %>"> <input type="hidden"
                                                            name="bookSeq" id="bookSeq"
                                                            value="<%= review.getBookSeq() %>">
        <% } else { %>
        <input type="hidden" name="bookSeq" id="bookSeq" value="<%=selectedBook!=null?selectedBook.getBookSeq():""%>">
        <% } %>
        ...
        <div class="mb-3">
            ...
            <div id="starRating" class="text-success fs-4">
                ...
                <i class="bi bi-star" data-value="1"></i> <i class="bi bi-star"
                                                             data-value="2"></i> <i class="bi bi-star"
                                                                                    data-value="3"></i> <i

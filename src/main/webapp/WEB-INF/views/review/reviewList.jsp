<%@ page language="java" contentType="text/html;charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="java.sql.Timestamp,java.util.List,com.gobookee.review.model.dto.Review,com.gobookee.common.DateTimeFormatUtil"%>
<%@ include file="/WEB-INF/views/common/header.jsp"%>
<%
List<Review> reviews = (List<Review>) request.getAttribute("list");
%>
<style>
body {
	...
	<div class="container py-4">
		...
		<div class="row row-cols-1 row-cols-md-4 g-4 mb-5">
			...
			<div class="col">
				...
				onclick="location.assign('<%=request.getContextPath()%>/review?reviewseq=<%=b.getReviewSeq() %>')">
            ...
            if (!reviews || reviews.length === 0) {
                ...
                reviews.forEach(function (b) {
                    ...
                    onclick="location.assign('<%=request.getContextPath()%>/review/reviewseq?seq=\${b.reviewSeq}')">
                    	<img src='images/latest1.jpg' alt='latest1' width='80' height='100' class='rounded'>
